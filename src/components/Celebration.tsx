        ...
        {step === "match" && (
          ...
          >
            ...
            <motion.h1
              ...
              style={{
                textShadow: "0 0 40px rgba(244, 63, 94, 0.15)",
              }}
            >
              Cocok!
            </motion.h1>
        ...
        {step === "greeting" && (
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden">
                  {uploadedPhoto ? (
                    <img src={uploadedPhoto} alt="Kamu" className="w-full h-full object-cover" draggable={false} />
                  ) : (
                    <div className="w-full h-full bg-rose-200 flex items-center justify-center text-rose-400 text-xl">?</div>
                  )}
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden">
                  <img src={targetPhoto} alt="Dia" className="w-full h-full object-cover" draggable={false} />
                </div>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              />
              <div
                className="relative bg-white/70 rounded-2xl p-6 sm:p-8"
                style={{ backdropFilter: "blur(10px)" }}
              >
                <p className="text-rose-700 text-base sm:text-lg leading-relaxed mb-4">
                  Di hari spesialmu ini, aku cuma mau bilang...
                </p>
                <p className="text-rose-800 text-lg sm:text-xl font-semibold leading-relaxed mb-4">
                  Kamu itu lebih dari sekadar teman. Kamu adalah orang yang selalu bikin hari-hariku lebih berwarna dan bermakna.
                </p>
                <p className="text-rose-600 text-base sm:text-lg leading-relaxed mb-4">
                  Semoga di tahun ini semua impian dan harapanmu tercapai. Semoga selalu bahagia, sehat, dan dikelilingi orang-orang yang menyayangimu.
                </p>
            ...
            <motion.div
              ...
              style={{
                ...
                background: `radial-gradient(circle, ${
                  ["rgba(244,63,94,0.08)", "rgba(236,72,153,0.06)", "rgba(217,70,239,0.05)", "rgba(251,113,133,0.07)", "rgba(249,168,212,0.06)"][i]
                } 0%, transparent 70%)`,
